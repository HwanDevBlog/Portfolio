		...
		<form role="form" method="post" autocomplete="off">
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td>
							<input class="form-control" type="text" id="bno" name="bno" value="${modify.bno}" readonly="readonly" />
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<textarea id="content" name="content" style="width: 100%; height: 300px;">${modify.content}</textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input class="form-control" type="text" id="writer" name="writer" value="${modify.writer}" readonly="readonly">
						</td>
					</tr>
					
					<tr>
						<td style="width: 150px;"><h5>작성 일자</h5></td>
						<td align="left">
					...
					<tr>
						<td colspan="2">
							...
							<input style="margin-right: 20px;" class="btn btn-primary pull-right" type="submit" value="수정완료">
						</td>
					</tr>
				</tbody>
			</table>
			...
			<script>
				...
				$("#cancel_btn").click(function() {	
					self.location = "/controller/board/read?bno=${modify.bno}"
						+ "&page=${scri.page}"
